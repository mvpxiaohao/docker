include DockerCookbook::DockerServiceBase
include DockerCookbook::DockerCommonProperties

resource_name :docker_service_manager_sysvinit_rhel

provides :docker_service_manager, platform: 'amazon' do |node|
  node['platform_version'].to_i >= 2012
end
...
provides :docker_service_manager_sysvinit, platform: 'amazon' do |node|
  node['platform_version'].to_i >= 2012
end
